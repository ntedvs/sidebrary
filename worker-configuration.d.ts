/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 79facb0e1c72c1a9a4f4fa4772d1d441)
// Runtime types generated with workerd@1.20260515.1 2025-05-01 nodejs_compat
interface __BaseEnv_Env {
	INTAKE_KV: KVNamespace;
	UPLOADS: R2Bucket;
	AI: Ai;
	PUBLIC_ORIGIN: "https://sidebrary-intake.ream-33b.workers.dev";
	CLOUDFLARE_ACCOUNT_ID: string;
	BROWSER_RENDERING_TOKEN: string;
	SITE_WORKFLOW: Workflow<Parameters<import("./worker/index").SiteGenerationWorkflow['run']>[0]['payload']>;
	INTAKE_LIMITER: RateLimit;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_ORIGIN" | "CLOUDFLARE_ACCOUNT_ID" | "BROWSER_RENDERING_TOKEN">> {}
}
